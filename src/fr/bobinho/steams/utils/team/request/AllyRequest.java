...
public class AllyRequest {
     ...
     */
    public AllyRequest(@Nonnull Team sender, @Nonnull Team receiver) {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof AllyRequest)) {
            return false;
        }
        AllyRequest testedAllyRequest = (AllyRequest) o;
        return testedAllyRequest.getSender().equals(getSender()) && testedAllyRequest.getReceiver().equals(getReceiver());
    }
